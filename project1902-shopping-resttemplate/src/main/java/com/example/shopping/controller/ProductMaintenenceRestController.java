...
public class ProductMaintenenceRestController {
    private final ProductMaintenanceService productMaintenanceService;

    public ProductMaintenenceRestController(ProductMaintenanceService productMaintenanceService) {
    ...
    public void putProduct(@PathVariable String id, @RequestBody ProductMaintenanceInput productMaintenanceInput) {
    ...
    public ResponseEntity<Product> registerProduct(
        ...
        Product product = productMaintenanceService.insert(productMaintenanceInput);
