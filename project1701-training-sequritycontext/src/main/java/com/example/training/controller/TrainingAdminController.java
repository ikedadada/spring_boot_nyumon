...
public class TrainingAdminController {
    ...
    public String postMethodName(@Validated TrainingAdminInput trainingAdminInput, BindingResult bindingResult) {
    ...
    public String postMethodName(@Validated TrainingAdminInput trainingAdminInput) {
        return "admin/training/updateForm";
    }

    // // Controllerから認証済みユーザーを取得する場合は以下のように書く
